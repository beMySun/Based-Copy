(function () {
    ...
    var app = {
        ...
        setPayData: function () {
            ...
            var applicantAddress = applicantInfoDom.find('.to-validate-address').val().trim()
            ...
            var payData = {
                ...
                targetInfo: JSON.parse(window.sessionStorage.getItem('petTarget'))
            };
        ...
        pay: function () {
            ...
            var imgData = JSON.parse(sessionStorage.getItem('imgDTO')) || [];

            $.ajax({
                url: '/icp/mobile_single_insurance/ptsApplyInsurance.do',
                type: 'post',
                data: payData,
        ...
        validate: function () {
            ...
            for (var i = 0; i < toValidateDomList.length; i++) {
                ...
                if (toValidateDom.hasClass('to-validate-address')) { // 详细地址
