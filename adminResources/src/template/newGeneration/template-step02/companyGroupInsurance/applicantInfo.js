(function() {
    ...
    var app = {
        ...
        setPayData: function() {
            ...
            var company = applicantInfoDom.find('.to-validate-company').val().trim();
            var category = applicantInfoDom.find('.to-validate-category').val().trim();
            var groupCertificateType = applicantInfoDom.find('.group-certificate-type').val().trim();
            var groupCertificate = applicantInfoDom.find('.to-validate-certificate').val().trim();
            var contact = applicantInfoDom.find('.to-validate-contact').val().trim();
            var contactPhone = applicantInfoDom.find('.to-validate-phone').val().trim();
            var contactEmail = applicantInfoDom.find('.to-validate-email').val().trim();
            ...
            var payData = {
                ...
                'ahsPolicy': {
                    ...
                    'policyBaseInfo': {
                        'totalModalPremium': $('#packageAmount').text().trim(),
                    ...
                    'policyExtendInfo': {
                        'isSendInvoice': '3',
                        'invokeMobilePhone': contactPhone,
                        'invokeEmail': contactEmail
                    },
                    'insuranceApplicantInfo': {
                        'groupPersonnelInfo': {
                            ...
                            'groupCertificateNo': groupCertificate,
                            'linkManName': contact,
                            'linkManMobileTelephone': contactPhone,
        ...
        validate: function() {
            ...
            for (var i = 0; i < toValidateDomList.length; i++) {
                ...
                if (toValidateDom.hasClass('to-validate-null')) { //客户名称、行业分类、联系人
