(function () {
    ...
    var app = {
        ...
        setPayData: function () {
            ...
            var houseAddress = houseInfoDom.find('.to-validate-address').val() + houseInfoDom.find('.to-validate-detail-address').val();
            var houseType = houseInfoDom.find('.house-type').val().trim();
        ...
        render: function () {
            ...
            $('.to-validate-address').cityPicker();
        },
